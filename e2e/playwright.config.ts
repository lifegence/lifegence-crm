...
const BASE_URL_SAAS = process.env.SAAS_BASE_URL || 'https://demo-clinic.saas.lifegence.com';
  ...
  projects: [
    {
      ...
      testDir: './tests',
      testMatch: /.*\.setup\.ts$/,
      use: { baseURL: BASE_URL_LOCAL, ignoreHTTPSErrors: true },
    },
    {
      name: 'setup-saas',
      testDir: './tests',
      testMatch: /.*\.setup\.ts$/,
      use: { baseURL: BASE_URL_SAAS },
    },
    {
      name: 'chromium-local',
      use: {
    ...
    },
    {
      ...
      use: {
        ...devices['Desktop Chrome'],
        baseURL: BASE_URL_SAAS,
        storageState: '.auth/admin.saas.json',
      },
      dependencies: ['setup-saas'],
    },
  ],
});
